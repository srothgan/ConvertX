...
export const loginResponseSchema = apiSuccess(
  z.object({
    authenticated: z.literal(true),
    redirectTo: z.string(),
    user: z.object({
...
export const logoffResponseSchema = apiSuccess(
  z.object({
    redirectTo: z.string()
  })
);
...
export type LoginResult = z.infer<typeof loginResponseSchema>["data"];
